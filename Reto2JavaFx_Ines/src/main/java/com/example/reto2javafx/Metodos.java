...
public class Metodos {
    ...
    public void listarJugadores()throws SQLException {
        ...
        System.out.println("-------------------------");
        System.out.println(" ");
        System.out.printf("%-10s %-10s %-10s %-15s %-15s %-10s %-10s %-10s %-10s %-10s %-10s\n",
                "Ranking", "RankingF", "Titulo", "Nombre", "Federacion", "Fide", "FideID", "Hotel", "CV", "ImporteP", "TipoTorneo");
        while (rs.next()) {
            ...
            System.out.printf("%-10d %-10d %-10s %-15s %-15s %-10d %-10s %-10b %-10b %-10d %-10s\n",
                    rankingI, rankingF, titulo, nombre, federacion, fide, fideID, hotel, cv, importeP, tipoTorneo);
            rs.close();
            st.close();
        }
    }
    ...
    public void altaJugador() throws SQLException, IOException {
        ...
        PreparedStatement ps = cnx.prepareStatement(
                "INSERT INTO jugador(rankingI, rankingF, titulo, nombre, federacion, fide, fideID, hotel, CV, importeP, categoria) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
