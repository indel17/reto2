...
public class Jugador {
    ...
    public Jugador(int rankingI, int rankingF, String titulo, String nombre, String federacion, int fide, String fideID, boolean hotel, boolean cv, int importeP, categoria tipoTorneo) {
