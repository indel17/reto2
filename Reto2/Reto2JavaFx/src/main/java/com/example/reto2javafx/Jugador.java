...
public class Jugador {
    ...
    public String toString() {
        return "Jugador: " +
                ...
                "\n\tpremioGanado=" + (premioGanado != null ? premioGanado.toString() : "N/A"); //he añadido para saber premio ganado
    }
...
public class Jugador {
    ...
    private categoria tipoTorneo;
    private boolean descalificado;
    private List<Premio> premiosOpta;
    private Premio premioGanado;

    public enum categoria {
        A, B
    }

    // Constructor para mostrar a los jugadores con su premio
    public Jugador(int rankingI, String nombre, categoria tipoTorneo, Premio premioGanado) {
        this.rankingI = rankingI;
        this.nombre = nombre;
        this.tipoTorneo = tipoTorneo;
        this.premioGanado = premioGanado;
    ...
    // Constructor para jugadores con premios opcionales
    public Jugador(int rankingI, String nombre, categoria tipoTorneo) {
        this.rankingI = rankingI;
        this.nombre = nombre;
        this.tipoTorneo = tipoTorneo;
        this.premiosOpta = new ArrayList<>();
    ...
    public Premio getPremioGanado() {
        return premioGanado;
    }

    public void setPremioGanado(Premio premioGanado) {
        this.premioGanado = premioGanado;
    }*/