...
public class Main extends Application {
    ...
    public static void main(String[] args) throws SQLException, IOException {
      /*launch(args);*/
        ...
        List<Jugador> jugadoresRankFB= csv.RankFExportarA("D:\\Desarollo Web\\Programación\\Retos\\Reto2\\Base de Datos\\clasificacionFinalOpenB.csv");
        csv.insertarRankF(jugadoresRankFB);
        csv.insertarRankF(jugadoresRankFA);
