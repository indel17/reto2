    ...
    public void start(Stage primaryStage) {
        try{
          ...
          /*  List<Jugador> listaJugadoresA = csv.importarjugadoresA("/home/ALU1J/Descargas/quieroElRanking/reto2-010arcos-patch-1/Reto2/Base de Datos/AOpen.xlsx");
            ...
            List<Jugador> jugadoresRankFA= csv.RankFExportarA("E:\\1DAWJ\\PROGRAMACIÓN\\clasificacionFinalOpenA.csv");
            List<Jugador> jugadoresRankFB= csv.RankFExportarB("E:\\1DAWJ\\PROGRAMACIÓN\\clasificacionFinalOpenB.csv");
