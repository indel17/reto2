...
//ver si marco lo retorna como lista y no como observable list
    ...
    private void btnOptarClicked() {
        ...
        if (jugadorSeleccionado != null) {
            try {
                ...
                alert.setHeaderText("Jugador no seleccionado");
                alert.setContentText("Por favor, seleccione un jugador para ver a qué premios opta.");
                alert.showAndWait();
        ...
        try {
            ...
            if (fideId == null || fideId.isEmpty()) {
                System.out.println("FideID no válido. Operación cancelada.");
                    ...
                    alert.setTitle("Advertencia");
                    alert.setHeaderText("Jugador no seleccionado");
                    alert.setContentText("Por favor, seleccione un jugador para eliminar.");
                    alert.showAndWait();
                return;
            }
    ...
    private void modificarJugador() {
        ...
        alert.setTitle("Advertencia");
        alert.setHeaderText("Jugador no seleccionado");
        alert.setContentText("Por favor, seleccione un jugador para modificar.");
        alert.showAndWait();
    }
    }
