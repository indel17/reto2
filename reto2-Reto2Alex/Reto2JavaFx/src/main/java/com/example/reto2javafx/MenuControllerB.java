...
public class MenuControllerB {
    ...
    public void setUpButtonHandlers() {
        btnJugadores.setOnAction(event -> loadScene(event, "JugadoresOpenB.fxml"));
        btnPremios.setOnAction(event -> loadScene(event, "VerPremiosOpenB.fxml"));
        btnClasificacion.setOnAction(event -> loadScene(event, "ClasificacionGeneralOpenB.fxml"));
